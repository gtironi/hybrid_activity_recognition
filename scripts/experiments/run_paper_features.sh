...
#   - CNN-LSTM  × {deep_only, hybrid} × {fromscratch, frompretrain_raw_ep40}
#   - PatchTST  × {deep_only, hybrid} × {fromscratch, frompretrain_raw_ep40}
